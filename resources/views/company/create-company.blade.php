    ...
    <div class="mx-auto max-w-xl">
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-100 px-6 py-5">
                <h1 class="text-xl font-extrabold tracking-tight text-slate-900">Cadastrar empresa</h1>
                <p class="mt-1 text-sm text-slate-500">Adicione uma nova empresa ao sistema.</p>
            </div>

            <form action="/management/company/create" method="POST" class="space-y-5 px-6 py-6">
                @csrf
                <div>
                    ...
                    <input type="text" name="companyName" id="companyName" required placeholder="Ex.: Doce Lar Ltda"
