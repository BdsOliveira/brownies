    ...
    <div class="mx-auto max-w-xl">
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-100 px-6 py-5">
                <h1 class="text-xl font-extrabold tracking-tight text-slate-900">Cadastrar vendedor</h1>
                <p class="mt-1 text-sm text-slate-500">Adicione um novo vendedor e vincule a uma empresa.</p>
            </div>

            <form action="/management/seller/create" method="POST" class="space-y-5 px-6 py-6">
                @csrf
                <div>
                    ...
                    <input type="text" name="nameSeller" id="nameSeller" required placeholder="Ex.: Maria Silva"
                        autocomplete="name"
                        class="block w-full rounded-xl border-slate-300 text-slate-900 shadow-sm focus:border-brand-500 focus:ring-brand-500">
                </div>

                <div>
                    <label for="id_company" class="mb-1.5 block text-sm font-semibold text-slate-700">
